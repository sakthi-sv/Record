...
public class AssignmentTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_assignment_tab,container,false);
        ...
        mRecycle =(RecyclerView)view.findViewById(R.id.recycler);
                        ...
                        public void onComplete(Task taskSnapshot) {
                            ...
                            httpsReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    mRef.child("assignments").child(classid).child(subject).child(n).child("link").setValue(uri.toString());             //uploding notes
                                    mRef.child("assignments").child(classid).child(subject).child(n).child("type").setValue(type);
                                }
                            });
                        ...
                        mRef.child("staff/" + mRoll).child("classid").addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Notes, NotesViewHolder>(
                                        ...
                                        mRef.child("assignments").child(classid).child(subject)
                                ) {
                                    @Override
